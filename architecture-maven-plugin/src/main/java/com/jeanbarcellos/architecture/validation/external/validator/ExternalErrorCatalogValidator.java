package com.jeanbarcellos.architecture.validation.external.validator;

import java.util.List;

import com.jeanbarcellos.architecture.validation.external.rule.ExternalErrorCodeRule;
import com.jeanbarcellos.architecture.validation.external.rule.ExternalErrorDescriptionRule;
import com.jeanbarcellos.architecture.validation.external.rule.ExternalErrorMappingRule;
import com.jeanbarcellos.architecture.validation.external.rule.ExternalErrorStatusRule;
import com.jeanbarcellos.architecture.validation.external.rule.ExternalErrorTypeMustBeEnumRule;
